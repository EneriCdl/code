...
const MC_DATA = {
  ...
  tutorials: [
    ...
    // ---- 1.12.2 经典 ----
    {
      ...
      category: "building",
      icon: "📦",
      description: "1.12.2经典全物品分类储存系统，利用漏斗+比较器实现多物品类型自动分类。支持70+种物品同时分类，生存后期基建核心。",
      materials: ["漏斗 ×128", "箱子 ×256", "红石比较器 ×64", "红石粉 ×96", "红石中继器 ×32", "建筑方块 ×512"],
      difficulty: "hard",
      version: "1.12.2",
      bilibiliSearch: "我的世界 1.12.2 全物品 分类 仓库 教程",
      tags: ["分类", "仓库", "1.12.2", "储存", "高级"],
      steps: ["规划仓库大厅空间", "铺设漏斗链分类水道", "每列安装比较器检测物品", "红石中继器锁住漏斗防止误吸", "标签每个箱子"]
    },
    {
      id: "piston-door-1-12",
      name: "1.12.2 大型活塞门/红石门",
      category: "machine",
      icon: "🚪",
      description: "1.12.2经典3×3无缝活塞门教程，利用粘性活塞+粘液块打造隐藏入口。适合生存基地大门和密室入口，红石入门必学。",
      materials: ["粘性活塞 ×12", "粘液块 ×8", "红石块 ×4", "红石粉 ×16", "红石中继器 ×4", "侦测器 ×4", "按钮 ×1"],
      difficulty: "medium",
      version: "1.12.2",
      bilibiliSearch: "我的世界 1.12.2 活塞门 红石门 教程",
      tags: ["活塞门", "1.12.2", "红石", "隐藏"],
      steps: ["在墙面规划3×3门洞", "安装粘性活塞框架", "粘液块连接活塞", "铺设红石控制线路", "安装按钮开关"]
    },
    {
      id: "slime-block-farm-1-12",
      name: "1.12.2 粘液块农场",
      category: "machine",
      icon: "🟢",
      description: "1.12.2版本利用史莱姆区块+铁傀儡的高效粘液球农场。粘液块是红石机械的核心材料，1.12.2中粘液块活塞门和飞行器需求量极大。",
      materials: ["台阶 ×128", "火把 ×32", "铁傀儡 ×1", "漏斗 ×8", "箱子 ×4", "岩浆块 ×8"],
      difficulty: "medium",
      version: "1.12.2",
      bilibiliSearch: "我的世界 1.12.2 史莱姆农场 粘液块 教程",
      tags: ["史莱姆", "粘液块", "1.12.2", "红石材料"],
      steps: ["使用ChunkBase找到史莱姆区块", "在Y=39以下挖掘多层平台", "半砖防止其他怪物生成", "铁傀儡引诱大型史莱姆", "岩浆块处理收集粘液球"]
    },
    // ---- 1.16.5 下界主题 ----
    {
      id: "crimson-house-1-16",
      name: "1.16.5 绯红森林主题建筑",
      category: "building",
      icon: "🏠",
      description: "1.16.5绯红森林风格的下界生存基地。利用绯红/诡异菌柄、菌光体、下界砖等新方块打造地狱中的安全绿洲。红色调为主，神秘华美。",
      materials: ["绯红菌柄 ×64", "诡异菌柄 ×32", "菌光体 ×16", "下界砖 ×48", "绯红木板 ×48", "哭泣黑曜石 ×8", "锁链 ×16", "绯红菌岩 ×32"],
      difficulty: "medium",
      version: "1.16.5",
      bilibiliSearch: "我的世界 1.16 绯红森林 建筑 下界 教程",
      tags: ["绯红", "下界", "1.16.5", "建筑", "中型"],
      steps: ["在绯红森林选址", "使用绯红菌柄搭建主体框架", "菌光体提供照明", "哭泣黑曜石做装饰点缀", "周围种植绯红菌和垂泪藤"]
    },
    {
      id: "nether-highway-1-16",
      name: "1.16.5 地狱交通系统/冰船道",
      category: "building",
      icon: "🛷",
      description: "1.16.5版本的地狱基岩上层交通网络。利用蓝冰+船的高速移动机制，在地狱顶层建造连接各生物群系和传送门的快速通道。时速可达每秒数百格。",
      materials: ["蓝冰 ×256", "半砖 ×128", "栅栏 ×64", "萤石 ×32", "按钮 ×32", "告示牌 ×16", "铁活板门 ×16"],
      difficulty: "medium",
      version: "1.16.5",
      bilibiliSearch: "我的世界 1.16 地狱交通 冰船道 教程",
      tags: ["交通", "冰船", "1.16.5", "地狱"],
      steps: ["突破地狱基岩顶层(Y=128)", "铺设半砖覆盖层防止刷怪", "蓝冰铺设主干道(3格宽)", "每隔50格设置萤石照明", "分支路口连接各传送门"]
    },
    {
      id: "hoglin-farm-1-16",
      name: "1.16.5 疣猪兽农场",
      category: "machine",
      icon: "🐗",
      description: "1.16.5版本在绯红森林建造的疣猪兽农场。疣猪兽掉落猪排和皮革，是下界生存的优质食物来源。利用诡异菌恐吓机制引导疣猪兽。",
      materials: ["诡异菌 ×16", "活板门 ×32", "漏斗 ×8", "箱子 ×4", "岩浆块 ×8", "绯红木板 ×32", "栅栏 ×16"],
      difficulty: "medium",
      version: "1.16.5",
      bilibiliSearch: "我的世界 1.16 疣猪兽 农场 教程",
      tags: ["疣猪兽", "食物", "1.16.5", "下界"],
      steps: ["在绯红森林搭建刷怪平台", "使用诡异菌引诱疣猪兽", "活板门引导至掉落通道", "岩浆块处理收集", "漏斗收集猪排和皮革"]
    },
    // ---- 1.18.2 洞穴山崖 ----
    {
      id: "mountain-villa-1-18",
      name: "1.18.2 山体别墅/洞穴豪宅",
      category: "building",
      icon: "⛰️",
      description: "1.18.2利用新山地地形在山体内开凿的豪华洞穴住宅。1.18巨型山脉提供了完美的建筑载体，大面积玻璃幕墙展示壮丽山景。",
      materials: ["玻璃 ×128", "深板岩砖 ×96", "平滑石 ×64", "云杉木 ×48", "海晶灯 ×24", "铁活板门 ×12", "灯笼 ×20", "苔藓块 ×32"],
      difficulty: "hard",
      version: "1.18.2",
      bilibiliSearch: "我的世界 1.18 山体别墅 洞穴建筑 教程",
      tags: ["山体", "洞穴", "1.18.2", "别墅", "高级"],
      steps: ["寻找1.18巨型山脉地形", "在山体内挖掘功能空间", "大面积玻璃幕墙面向峡谷", "深板岩砖铺设内部墙面", "苔藓块和灯笼装饰"]
    },
    {
      id: "ancient-city-restore-1-18",
      name: "1.18.2 远古城市修复与改造",
      category: "building",
      icon: "🏚️",
      description: "1.18.2在深暗之域发现的远古城市修复教程。清理循声守卫威胁后，利用深板岩和幽匿系列方块修复并改造远古城市为可居住的地下基地。",
      materials: ["羊毛 ×128", "深板岩砖 ×96", "幽匿块 ×32", "红石灯 ×24", "灵魂灯笼 ×16", "强化深板岩 ×48", "幽匿催化剂 ×8", "紫水晶块 ×16"],
      difficulty: "hard",
      version: "1.18.2",
      bilibiliSearch: "我的世界 1.18 远古城市 修复 建筑教程",
      tags: ["远古城市", "修复", "1.18.2", "深暗之域"],
      steps: ["携带大量羊毛进入深暗之域", "铺设羊毛通道避免振动", "使用活塞或爆破清理循声尖啸体", "修复损毁的建筑结构", "安装红石灯照明系统"]
    },
    {
      id: "dripstone-farm-1-18",
      name: "1.18.2 滴水石锥农场",
      category: "machine",
      icon: "🕯️",
      description: "1.18.2利用滴水石锥的全自动熔岩农场和无限水补充系统。上方放置水/熔岩，下方钟乳石缓慢滴落填充炼药锅。后期熔岩能源农场的基础。",
      materials: ["滴水石锥 ×32", "炼药锅 ×16", "熔岩桶 ×4", "水桶 ×8", "漏斗 ×8", "箱子 ×4", "侦测器 ×4", "建筑方块 ×64"],
      difficulty: "medium",
      version: "1.18.2",
      bilibiliSearch: "我的世界 1.18 滴水石锥 熔岩 农场 教程",
      tags: ["滴水石锥", "熔岩", "1.18.2", "自动"],
      steps: ["搭建多层滴水石锥阵列", "上层放置熔岩源", "下层钟乳石下方放置炼药锅", "侦测器检测炼药锅填满", "漏斗收集熔岩桶"]
    },
    // ---- 1.20 足迹与故事 ----
    {
      id: "cherry-blossom-house-1-20",
      name: "1.20 樱花林和风庭院",
      category: "building",
      icon: "🌸",
      description: "1.20樱花林生物群系的日式和风庭院。利用粉色樱花木板、竹子、樱花树叶打造浪漫的粉色主题建筑群落。1.20新增的樱花方块是核心建材。",
      materials: ["樱花原木 ×96", "樱花木板 ×128", "樱花树叶 ×64", "竹子 ×48", "粉红色羊毛 ×16", "灯笼 ×20", "水桶 ×4", "砂砾 ×32"],
      difficulty: "medium",
      version: "1.20",
      bilibiliSearch: "我的世界 1.20 樱花 建筑 教程",
      tags: ["樱花", "和风", "1.20", "建筑", "中型"],
      steps: ["在樱花林中选择开阔地带", "樱花原木搭建主体结构", "樱花木板铺设地板和墙壁", "樱花树叶装饰屋顶线条", "竹子围栏和枯山水庭院"]
    },
    {
      id: "archaeology-site-1-20",
      name: "1.20 考古挖掘场/嗅探兽农场",
      category: "machine",
      icon: "🏺",
      description: "1.20利用嗅探兽挖掘远古种子的自动化考古农场。嗅探兽从可疑的沙砾中挖掘陶片和种子，配合刷子可获取1.20新增的全部考古物品。",
      materials: ["嗅探兽 ×4", "可疑的沙砾 ×32", "刷子 ×4", "漏斗 ×8", "箱子 ×4", "活板门 ×8", "栅栏 ×16", "火把花 ×8"],
      difficulty: "medium",
      version: "1.20",
      bilibiliSearch: "我的世界 1.20 考古 嗅探兽 农场 教程",
      tags: ["考古", "嗅探兽", "1.20", "陶片"],
      steps: ["在沙漠神殿或古迹收集可疑沙砾", "搭建嗅探兽围栏和挖掘区", "铺设可疑沙砾供嗅探兽挖掘", "漏斗收集挖掘出的种子和陶片", "用刷子刷可疑沙砾获取额外物品"]
    },
    {
      id: "bamboo-wood-farm-1-20",
      name: "1.20 全自动竹林农场",
      category: "machine",
      icon: "🎋",
      description: "1.20版本利用飞行器+侦测器的全自动竹林农场。1.20新增竹子方块(竹块/竹马赛克)使竹子成为完整建材。此农场为竹建提供充足原材料。",
      materials: ["侦测器 ×12", "活塞 ×10", "粘液块 ×6", "红石块 ×2", "漏斗 ×8", "箱子 ×4", "玻璃 ×16", "骨粉 ×32"],
      difficulty: "medium",
      version: "1.20",
      bilibiliSearch: "我的世界 1.20 竹子 农场 自动 教程",
      tags: ["竹子", "1.20", "自动", "建材"],
      steps: ["种植一排竹子(最长16格)", "建造双方向飞行器", "飞行器来回推动收割竹子", "水流或漏斗收集掉落物", "连接到箱子储存"]
    },
    {
      id: "camel-stable-1-20",
      name: "1.20 骆驼厩/沙漠驿站建筑",
      category: "building",
      icon: "🐪",
      description: "1.20沙漠村庄风格的骆驼厩建筑，使用1.20新增的竹块和竹马赛克搭配沙石建造。骆驼是1.20新增的可双人骑乘生物，此建筑为其提供栖息地。",
      materials: ["沙石 ×64", "平滑沙石 ×48", "竹块 ×32", "竹马赛克 ×32", "干草块 ×16", "栅栏 ×32", "灯笼 ×12", "骆驼 ×2"],
      difficulty: "easy",
      version: "1.20",
      bilibiliSearch: "我的世界 1.20 骆驼 建筑 教程",
      tags: ["骆驼", "1.20", "沙漠", "建筑", "简单"],
      steps: ["在沙漠村庄附近选址", "沙石和竹块混合搭建厩舍", "干草块铺设内部地面", "竹马赛克装饰墙面", "栅栏围出骆驼活动区"]
    },
    // ---- 1.21 试炼 ----
    {
      id: "trial-chamber-farm-1-21",
      name: "1.21 试炼密室改造刷怪塔",
      category: "machine",
      icon: "🏟️",
      description: "1.21利用天然试炼密室改造的高效刷怪塔。试炼密室中的刷怪笼在试炼模式下无限刷新旋风人、沼骸等新怪物。配合水流收集系统实现全自动击杀。",
      materials: ["水桶 ×8", "活板门 ×32", "漏斗 ×12", "箱子 ×8", "岩浆块 ×16", "萤石 ×16", "铁活板门 ×8", "不祥之兆药水 ×4"],
      difficulty: "hard",
      version: "1.21",
      bilibiliSearch: "我的世界 1.21 试炼密室 刷怪塔 教程",
      tags: ["试炼密室", "1.21", "刷怪", "高级"],
      steps: ["找到地下试炼密室并探明结构", "清理不必要空间", "改造刷怪笼周围布局", "设置水流引导怪物集中", "漏斗+岩浆块收集系统"]
    },
    {
      id: "breeze-farm-1-21",
      name: "1.21 旋风人农场/风弹收集器",
      category: "machine",
      icon: "💨",
      description: "1.21专门针对旋风人的自动化农场。旋风人掉落风弹和微风棒，风弹是1.21新武器重锤的核心合成材料。利用试炼刷怪笼持续生成旋风人。",
      materials: ["活板门 ×24", "漏斗 ×8", "箱子 ×4", "玻璃 ×16", "红石灯 ×8", "铁活板门 ×8", "岩浆块 ×8", "不祥之兆药水 ×2"],
      difficulty: "hard",
      version: "1.21",
      bilibiliSearch: "我的世界 1.21 旋风人 农场 教程",
      tags: ["旋风人", "1.21", "风弹", "试炼"],
      steps: ["在试炼密室找到旋风人刷怪笼", "搭建封闭刷怪空间", "利用旋风人AI引导至击杀区", "岩浆块自动处理", "漏斗收集风弹和微风棒"]
    },
    {
      id: "mace-trap-1-21",
      name: "1.21 重锤陷阱/高处坠落击杀装置",
      category: "machine",
      icon: "🔨",
      description: "1.21利用重锤蓄力坠落伤害机制的自动化击杀装置。玩家从高处跳下用重锤攻击敌人，伤害随坠落高度叠加。配合史莱姆方块弹跳复用实现连续击杀。",
      materials: ["重锤 ×1", "史莱姆方块 ×8", "蜂蜜块 ×4", "活板门 ×16", "漏斗 ×6", "箱子 ×4", "黑曜石 ×8", "水桶 ×2"],
      difficulty: "hard",
      version: "1.21",
      bilibiliSearch: "我的世界 1.21 重锤 陷阱 教程",
      tags: ["重锤", "1.21", "武器", "装置"],
      steps: ["搭建高塔(20+格)", "塔顶设置史莱姆弹跳平台", "塔下设置怪物引导区", "玩家从塔顶跳下用重锤击杀", "史莱姆方块回弹复用"]
    },
    {
      id: "vault-farm-1-21",
      name: "1.21 宝库钥匙农场/试炼刷怪阵列",
      category: "machine",
      icon: "🔑",
      description: "1.21高效获取宝库钥匙的自动化农场。通过持续触发试炼刷怪笼并击杀试炼怪物获取宝库钥匙，用于打开试炼密室中的战利品宝库获取稀有重锤附魔。",
      materials: ["不祥之兆药水 ×8", "漏斗 ×8", "箱子 ×4", "活板门 ×24", "铁活板门 ×8", "萤石 ×16", "命名牌 ×2", "岩浆块 ×8"],
      difficulty: "hard",
      version: "1.21",
      bilibiliSearch: "我的世界 1.21 宝库钥匙 试炼 农场 教程",
      tags: ["宝库", "钥匙", "1.21", "试炼"],
      steps: ["定位试炼密室位置", "饮用不祥之兆药水触发试炼", "改造刷怪笼周围为收集区", "高效击杀试炼怪物", "收集宝库钥匙打开宝库"]
    },
    {
      id: "armadillo-farm-1-21",
      name: "1.21 犰狳养殖场/狼铠材料农场",
      category: "machine",
      icon: "🦔",
      description: "1.21犰狳自动化养殖农场。犰狳掉落犰狳鳞甲用于合成狼铠，是1.21新增宠物装备系统的核心材料。配合刷子可获取更多鳞甲。",
      materials: ["犰狳 ×4", "刷子 ×4", "漏斗 ×6", "箱子 ×4", "栅栏 ×16", "玻璃 ×8", "蜘蛛眼 ×16", "活板门 ×8"],
      difficulty: "easy",
      version: "1.21",
      bilibiliSearch: "我的世界 1.21 犰狳 农场 狼铠 教程",
      tags: ["犰狳", "1.21", "狼铠", "养殖"],
      steps: ["在热带草原群系找到犰狳", "搭建封闭养殖围栏", "使用蜘蛛眼繁殖犰狳", "定期使用刷子收集鳞甲", "漏斗收集掉落物"]
    }
  ],
  ...
  resources: [
    ...
    // ---- 多版本资源 ----
    {
      ...
      name: "MakeUp Ultra Fast (全版本)",
      type: "shader",
      icon: "⚡",
      description: "极致性能优化的光影包，集成显卡也能流畅运行。保持基础光影效果的同时大幅降低GPU负载。适合需要光影但配置有限的玩家，全版本通用。",
      version: "全版本",
      tags: ["光影", "低配", "全版本", "性能"],
      downloadUrl: "https://www.curseforge.com/minecraft/customization/makeup-ultra-fast-shaders",
      downloadLabel: "CurseForge 下载",
      rating: "★4.5"
    },
    {
      id: "nostalgia-shader",
      name: "Nostalgia Shader (全版本)",
      type: "shader",
      icon: "🌻",
      description: "复古怀旧风格的光影包，模拟Minecraft早期光影的暖黄色调。体积云和柔和光照是其标志性特征。适合喜欢温馨画面的玩家，全版本兼容。",
      version: "全版本",
      tags: ["光影", "复古", "全版本", "暖色调"],
      downloadUrl: "https://www.curseforge.com/minecraft/customization/nostalgia-shader",
      downloadLabel: "CurseForge 下载",
      rating: "★4.4"
    },
    {
      id: "sildurs-vibrant-1-16",
      name: "Sildur's Vibrant (1.16.5)",
      type: "shader",
      icon: "🌇",
      description: "Sildur's Vibrant高画质版光影1.16.5适配。相比基础版增加了体积光、镜头光晕、动态反射等效果。适合中高配机器，1.16.5大型整合包的标配光影。",
      version: "1.16.5",
      tags: ["光影", "1.16.5", "高画质", "体积光"],
      downloadUrl: "https://www.curseforge.com/minecraft/customization/sildurs-shaders/files?filter-game-version=2020709689%3A7086",
      downloadLabel: "CurseForge 下载",
      rating: "★4.8"
    },
    {
      id: "faithful-64x",
      name: "Faithful 64x (全版本)",
      type: "resource-pack",
      icon: "💎",
      description: "Faithful的64×64高清进阶版。在保留原版风格的基础上将分辨率翻倍，方块纹理细节更加丰富。适合中配机器，兼顾画质与性能。",
      version: "全版本",
      tags: ["材质包", "64x", "高清", "全版本"],
      downloadUrl: "https://www.curseforge.com/minecraft/texture-packs/faithful-64x",
      downloadLabel: "CurseForge 下载",
      rating: "★4.8"
    },
    {
      id: "mizunos-16-cit",
      name: "Mizuno's 16 CIT (全版本)",
      type: "resource-pack",
      icon: "🧺",
      description: "日系温馨风格的16×像素材质包，虽然分辨率低但细节极其丰富。搭配CIT功能可自定义物品贴图。建筑党和内饰党最爱，适合温馨风格建筑。",
      version: "全版本",
      tags: ["材质包", "日系", "16x", "全版本"],
      downloadUrl: "https://www.curseforge.com/minecraft/texture-packs/mizunos-16-craft-cit",
      downloadLabel: "CurseForge 下载",
      rating: "★4.7"
    },
    {
      id: "default-plus-1-20",
      name: "Default+ (1.20)",
      type: "resource-pack",
      icon: "🖌️",
      description: "原版增强型材质包，保持16×16分辨率但优化了每个方块的纹理过渡和连接性。3D模型增强使草丛、藤蔓等植物更立体。1.20樱花更新已完美适配。",
      version: "1.20",
      tags: ["材质包", "原版增强", "1.20", "16x"],
      downloadUrl: "https://www.curseforge.com/minecraft/texture-packs/default-plus",
      downloadLabel: "CurseForge 下载",
      rating: "★4.6"
    },
    {
      id: "canary-shader-1-12",
      name: "Canary Shader (1.12.2)",
      type: "shader",
      icon: "🐤",
      description: "1.12.2老版本玩家的光影新选择。在维持老版本兼容性的同时提供接近新版光影的视觉效果。对AMD显卡优化良好，1.12.2模组整合包的光影首选。",
      version: "1.12.2",
      tags: ["光影", "1.12.2", "AMD优化", "兼容"],
      downloadUrl: "https://www.curseforge.com/minecraft/customization/canary-shader",
      downloadLabel: "CurseForge 下载",
      rating: "★4.3"
    },
    {
      id: "chocapic13-1-18",
      name: "Chocapic13 (1.18.2)",
      type: "shader",
      icon: "🍫",
      description: "经典光影Chocapic13的1.18.2适配版。提供从Low到Extreme多档配置。低配版流畅度高，Extreme版拥有顶级光影表现。1.18大型地形下的性价比之选。",
      version: "1.18.2",
      tags: ["光影", "1.18.2", "多配置", "经典"],
      downloadUrl: "https://www.curseforge.com/minecraft/customization/chocapic13-shaders",
      downloadLabel: "CurseForge 下载",
      rating: "★4.5"
    }
  ],
